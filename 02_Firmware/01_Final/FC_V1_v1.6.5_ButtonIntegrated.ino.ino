...
//
// Firmware:
// FC_V1_v1.6.5_ButtonIntegrated
//
// Based on stable V1.6.4 logic.
//
// NEW:
// - Physical push button on GPIO4
// - Short press:
//      IDLE  -> ARMED
//      ARMED -> IDLE
// - Long press (~2s):
...
void initializeHardware()
{
  ...
  Serial.println(" Firmware V1.6.5");
  Serial.println("================================");
  ...
  )
  {
    ...
    )
    {
      ...
      else
      {
        ...
        // If long press was not already executed,
        // this is treated as a short press.
...
{
  // ----------------------------------------------------------
  // Button must be checked continuously
  // ----------------------------------------------------------
